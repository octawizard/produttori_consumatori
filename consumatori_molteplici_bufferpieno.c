...
int main ( void )
{
   ...
   suite_consumatorimolteplici_bufferpieno_bloccante = CU_add_suite( "suite_consumatorimolteplici_bufferpieno_bloccante", init_suite_consumatorimolteplici_bufferpieno, clean_suite_consumatorimolteplici_bufferpieno );
   ...
   if ( (NULL == CU_add_test(suite_consumatorimolteplici_bufferpieno_bloccante, "test_iniziale_semafori_getbloccante_bufferpieno", test_iniziale_semafori_getbloccante_bufferpieno)) ||
        (NULL == CU_add_test(suite_consumatorimolteplici_bufferpieno_bloccante, "test_consumatorimolteplici_getbloccante_bufferpieno", test_consumatorimolteplici_getbloccante_bufferpieno)) ||
        (NULL == CU_add_test(suite_consumatorimolteplici_bufferpieno_bloccante, "test_finale_semafori_getbloccante_bufferpieno", test_finale_semafori_getbloccante_bufferpieno))
    )
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   suite_consumatorimolteplici_bufferpieno_nonbloccante = CU_add_suite( "suite_consumatorimolteplici_bufferpieno_nonbloccante", init_suite_consumatorimolteplici_bufferpieno, clean_suite_consumatorimolteplici_bufferpieno);
   ...
   if ( (NULL == CU_add_test(suite_consumatorimolteplici_bufferpieno_nonbloccante, "test_iniziale_semafori_getnonbloccante_bufferpieno", test_iniziale_semafori_getnonbloccante_bufferpieno)) ||
        (NULL == CU_add_test(suite_consumatorimolteplici_bufferpieno_nonbloccante, "test_produttorimolteplici_getnonbloccante_bufferpieno", test_produttorimolteplici_getnonbloccante_bufferpieno)) ||
        (NULL == CU_add_test(suite_consumatorimolteplici_bufferpieno_nonbloccante, "test_finale_semafori_getnonbloccante_bufferpieno", test_finale_semafori_getnonbloccante_bufferpieno))
    )
   {
      CU_cleanup_registry();
      return CU_get_error();
