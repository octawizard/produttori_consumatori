...
int clean_suite_produttorimolteplici_buffervuoto(void) { 
  ...
  printf("\nsto per fare la destroy del buffer\n");
  buffer_destroy(buffer);
  printf("\nho finito la destroy del buffer\n");
  return 0; 
}
...
int main ( void )
{
   ...
   suite_produttorimolteplici_buffervuoto_bloccante_buffernonsatura = CU_add_suite( "suite_produttorimolteplici_buffervuoto_bloccante_buffernonsatura", init_suite_produttorimolteplici_buffervuoto, clean_suite_produttorimolteplici_buffervuoto );
   ...
   if ( (NULL == CU_add_test(suite_produttorimolteplici_buffervuoto_bloccante_buffernonsatura, "test_iniziale_semafori_putbloccante_buffervuoto_buffernonsatura", test_iniziale_semafori_putbloccante_buffervuoto_buffernonsatura)) ||
        (NULL == CU_add_test(suite_produttorimolteplici_buffervuoto_bloccante_buffernonsatura, "test_produttorimolteplici_putbloccante_buffervuoto_buffernonsatura", test_produttorimolteplici_putbloccante_buffervuoto_buffernonsatura)) ||
        (NULL == CU_add_test(suite_produttorimolteplici_buffervuoto_bloccante_buffernonsatura, "test_finale_semafori_putbloccante_buffervuoto_buffernonsatura", test_finale_semafori_putbloccante_buffervuoto_buffernonsatura))
    )
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   suite_produttorimolteplici_buffervuoto_nonbloccante_buffernonsatura = CU_add_suite( "suite_produttorimolteplici_buffervuoto_nonbloccante_buffernonsatura", init_suite_produttorimolteplici_buffervuoto, clean_suite_produttorimolteplici_buffervuoto);
   ...
   if ( (NULL == CU_add_test(suite_produttorimolteplici_buffervuoto_nonbloccante_buffernonsatura, "test_iniziale_semafori_putnonbloccante_buffervuoto_buffernonsatura", test_iniziale_semafori_putnonbloccante_buffervuoto_buffernonsatura)) ||
        (NULL == CU_add_test(suite_produttorimolteplici_buffervuoto_nonbloccante_buffernonsatura, "test_produttorimolteplici_putnonbloccante_buffervuoto", test_produttorimolteplici_putnonbloccante_buffervuoto)) ||
        (NULL == CU_add_test(suite_produttorimolteplici_buffervuoto_nonbloccante_buffernonsatura, "test_finale_semafori_putnonbloccante_buffervuoto_buffernonsatura", test_finale_semafori_putnonbloccante_buffervuoto_buffernonsatura))
    )
   {
      CU_cleanup_registry();
      return CU_get_error();
