...
int main ( void )
{
   ...
   suite_produttorimolteplici_buffervuoto_bloccante_buffersatura = CU_add_suite( "suite_produttorimolteplici_buffervuoto_bloccante_buffersatura", init_suite_produttorimolteplici_buffervuoto, clean_suite_produttorimolteplici_buffervuoto );
   ...
   if ( (NULL == CU_add_test(suite_produttorimolteplici_buffervuoto_bloccante_buffersatura, "test_iniziale_semafori_putbloccante_buffervuoto_buffersatura", test_iniziale_semafori_putbloccante_buffervuoto_buffersatura)) ||
        (NULL == CU_add_test(suite_produttorimolteplici_buffervuoto_bloccante_buffersatura, "test_produttorimolteplici_putbloccante_buffervuoto_buffersatura", test_produttorimolteplici_putbloccante_buffervuoto_buffersatura)) ||
        (NULL == CU_add_test(suite_produttorimolteplici_buffervuoto_bloccante_buffersatura, "test_finale_semafori_putbloccante_buffervuoto_buffersatura", test_finale_semafori_putbloccante_buffervuoto_buffersatura))
    )
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   suite_produttorimolteplici_buffervuoto_nonbloccante_buffersatura = CU_add_suite( "suite_produttorimolteplici_buffervuoto_nonbloccante_buffersatura", init_suite_produttorimolteplici_buffervuoto, clean_suite_produttorimolteplici_buffervuoto);
   ...
   if ( (NULL == CU_add_test(suite_produttorimolteplici_buffervuoto_nonbloccante_buffersatura, "test_iniziale_semafori_putnonbloccante_buffervuoto_buffersatura", test_iniziale_semafori_putnonbloccante_buffervuoto_buffersatura)) ||
        (NULL == CU_add_test(suite_produttorimolteplici_buffervuoto_nonbloccante_buffersatura, "test_produttorimolteplici_putnonbloccante_buffervuoto", test_produttorimolteplici_putnonbloccante_buffervuoto)) ||
        (NULL == CU_add_test(suite_produttorimolteplici_buffervuoto_nonbloccante_buffersatura, "test_finale_semafori_putnonbloccante_buffervuoto_buffersatura", test_finale_semafori_putnonbloccante_buffervuoto_buffersatura))
    )
   {
      CU_cleanup_registry();
      return CU_get_error();
